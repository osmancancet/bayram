...
function getCountdown(targetSaat: string): string | null {
  // Bayram namazı tarihi: 20 Mart 2026
  ...
  if (days > 0) return `${days} gün ${hrs} saat ${mins} dk`;
...
export default function PrayerTimeCard({ city, ilce }: PrayerTimeCardProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-white/40 text-xs mb-4">Bayram Namazı Saati</p>
